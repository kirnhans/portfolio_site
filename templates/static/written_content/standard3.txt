...
<table>
    <tr>
        ...
        <td class = "column-header"> Examples</td>
    </tr>
    <tr>
        <td>Cultural festivals and showcases</td>
        <td>Food, dance, art, history, carnivals</td>
    </tr>
    <tr>
        <td>Curricular</td>
        <td>Science fairs, panels, Model United Nations, plays, sports matches, homework clubs</td>
    </tr>
</table>
*Common Events*
</center>
...
For more in-depth explanations of the strategies we devised, click [here](static/pdfs/Outreach_strategies.pdf).
