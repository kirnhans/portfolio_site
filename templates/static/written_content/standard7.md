...
<center>
![Texas School Guide, 2021](static\images\Parent-Involvement-1024x312.png)
...
<table>
    <tr>
        <td class = "column-header"> Situation </td>
        <td class = "column-header"> Impacted areas </td>
    </tr>
    <tr>
        <td>Poverty</td>
        <td>Monetary resources, time</td>
    </tr>
    <tr>
        <td>Different primary language</td>
        <td>Communication</td>
    </tr>
    <tr>
        <td>Disability/chronic illness</td>
        <td>Physical/mental energy, physical access</td>
    </tr>
    <tr>
        <td>Difficult working hours</td>
        <td>Time</td>
    </tr>
    <tr>
        <td>Low education</td>
        <td>Ability to support schoolwork</td>
    </tr>
    <tr>
        <td>Lack of transportation</td>
        <td>Meetings at school</td>
    </tr>
</table>
...
-   *Parents as Partners | Texas School Guide*. (2021). Texas School Guide. [https://texasschoolguide.org/parents-as-partners/](https://texasschoolguide.org/parents-as-partners/)